...
insert into prizes (key, title, short_title, icon, tier, weight, expires_in_days, color, sort_order) values
  ...
  ('discount_10', 'Скидка 10% на визит',  'Скидка 10%', '🏷', 'COMMON', 20, 5, '#a6ff2f', 3),
  ('snack',       'Снек в подарок',       'Снек',       '🍿', 'COMMON', 15, 3, '#ffb02e', 4),
  ('drink',       'Напиток в подарок',    'Напиток',    '🥤', 'COMMON', 15, 3, '#ff5c8a', 5),
